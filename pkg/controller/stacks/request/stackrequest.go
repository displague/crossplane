...
// Add creates a new StackRequest Controller and adds it to the Manager with default RBAC.
...
func Add(mgr manager.Manager) error {
	...
	// Watch for changes to StackRequest
	return c.Watch(&source.Kind{Type: &v1alpha1.StackRequest{}}, &controllerHandler.EnqueueRequestForObject{})
}
